    ...
    <>
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div>
                ...
                <h5 className="tentang small" style={{ fontWeight: 450, paddingBottom: '50px' }}>
      ...
      <div className="container">
        ...
        <div className="resep" id="resep">
          <h1 style={{ textAlign: 'center', fontSize: '25px', fontWeight: 600, paddingTop: '5%' }}>Resep - Resep</h1>
          <p style={{ textAlign: 'center' }}>Sambutlah petualangan rasa yang autentik dengan koleksi resep kami, hadirkan kelezatan sejati dari setiap sudut Nusantara langsung ke meja makan Anda.</p>
        ...
        <section className="artikel">
          <div className="container">
            <h1 style={{ textAlign: 'center', fontSize: '25px', fontWeight: 600, paddingTop: '5%' }}>Artikel</h1>
            <p style={{ textAlign: 'center' }}>Temukan inspirasi masak yang tak terbatas dengan artikel kami yang penuh dengan tips, trik, dan informasi terkini tentang kuliner dari seluruh Nusantara.</p>
            ...
            <div className="artikelain text-center" style={{ paddingTop: '20px' }}>
              <button type="button" className="btn btn-primary btn-custom">Lihat Artikel Lainnya</button>
            </div>
          </div>
        </section>
        ...
        <section className="forum" id="forum">
          <div className="headerforum">
            ...
            <p style={{ textAlign: 'center' }}>Bergabunglah dengan komunitas kami! Bagikan resep unikmu, inspirasi kuliner, dan jadilah bagian dari perjalanan kulinermu yang seru bersama kami.</p>
          </div>
          <div className="container">
            ...
            <div className="forumlain text-center" style={{ paddingTop: '20px', paddingBottom: '20px' }}>
              <button type="button" className="btn btn-primary btn-custom" onClick={redirectToForumPage}>Forum Lainnya</button>
            </div>
          </div>
        </section>
      </div>
