...
const ForumCardTanpaGambar = ({ image, title, tags, uploadedTime, profileImage, profileName, profileRole, likeCount, viewCount, commentCount }) => {
...
export default ForumCardTanpaGambar;
